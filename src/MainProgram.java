...
public class MainProgram {
	...
	public static void main(String [] args){
		...
		System.out.println("This time test to add java project to git");
		System.out.println("Step[1] : create java project and/or source code");
		System.out.println("Step[2] : commit your code to create master");
